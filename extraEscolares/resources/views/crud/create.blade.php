...
@section('contenido')
    ...
    <form class="row g-3 fs-4" action="store" method="post">
        ...
        <div class="col-md-6 mt-4">
            ...
            <input type="number" name="numero_control" id="numero_control" class="form-control" >
        </div>
        ...
        <div class="col-6 mt-4">
            ...
            <input type="text" name="escuela_anterior" id="escuela_anterior" class="form-control" >
        </div>
        <div class="col-6 mt-4">
